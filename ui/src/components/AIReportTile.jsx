...
export default function AIReportTile({stock}) {
  ...
  return (
      <>
        <div
            className={`${tileClasses.bg} ${tileClasses.border} border rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow cursor-pointer`}
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex gap-2 sm:gap-3 w-full mt-2">
              <div
                  className={`flex-1 py-1 px-2 sm:px-3 rounded ${tileClasses.scoreBg}`}>
                <div className="text-xs text-gray-600">Promise</div>
                <div
                    className={`${tileClasses.scoreText} font-bold text-sm sm:text-base`}>
